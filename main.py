...
print("\n𝐗𝐁𝐨𝐭𝐬 𝐃𝐞𝐩𝐥𝐨𝐲𝐞𝐝 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 ⚡\nMy Master ---> 🦋⃟  𝐒 𝐇 𝐈 𝐕 🜲 💸\>ॐ𝐌ʀ भगवाधारी𝐍⃝⃝⃪⃕⃝⃝⃪⃝⃝⃪⃕⃝⃝⃝⃝⃪⃕⃝⃝⃪⃝⃝⃪⃕⃝⃝⃪⃕⃝⃝⃪⃝⃝⃪⃕⃝⃝⃝⃝⃪⃕⃝⃝⃪⃝⃝⃪⃝⃝⃪⃝⃝⃪⃕⃝⃝⃪⃕⃝⃝⃪⃝⃝⃪⃕⃝⃝⃝⃝⃪⃕⃝⃝⃪⃝⃝⃪⃝⃝⃪⃝⃝⃪⃕⃝⃝⃪⃕⃝⃝⃪⃝⃝⃪⃕⃝⃝⃝⃝⃪⃕⃝⃝⃪⃝⃝⃪⃝⃝⃪⃝⃝⃪⃕⃝⃝⃪⃕⃝⃝⃪⃝⃝⃪⃕⃝⃝⃝⃝⃪⃕⃝⃝⃪⃝⃝⃪⃝⃝⃪⃝⃝⃪⃕⃝⃝⃪⃕⃝⃝⃪⃝⃝⃪⃕⃝⃝⃝⃝⃪⃕⃝⃝⃪⃝⃝⃪⃝⃝⃪⃝⃝⃪⃕⃝⃝⃪⃕⃝⃝⃪⃝⃝⃪⃕⃝⃝⃝⃝⃪⃕⃝⃝⃪⃝⃝⃪⃝⃝⃪⃝⃝⃪⃕⃝⃕🦋͜͡•─⃛͢ @ll_SABKA_BHAI_KILLER_ll")
